...
if(isset($_POST['sekil'])){$_sekil = intval($_POST['sekil']);}else{$_sekil = 0;};
if(isset($_POST['istenen'])){$_istenen = intval($_POST['istenen']);}else{$_istenen = 0;};
if(isset($_POST['param'])){$_param = $_POST['param'];}else{$_param = 0;};
